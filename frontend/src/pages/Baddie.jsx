  ...
  return (
    <div className='w-screen h-screen overflow-hidden relative'>
      ...
      style={{backgroundImage:`url(${bgImage})`}}>
        ...
        {/* Arrow to go back */}
        <div className='flex text-white absolute top-15 left-4 md:left-20 text-2xl md:text-5xl w-20 h-10 md:w-20 md:h-20 bg-green-700/80 justify-center items-center rounded-full
        shadow-lg cursor-pointer hover:bg-green-500/70 hover:scale-120 hover:shadow-2xl'>
